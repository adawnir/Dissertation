...
# Save outputs
saveRDS(out_lux, "../Results/Luxembourg/Stab_clustering_output.rds")
saveRDS(out_fra, "../Results/France/Stab_clustering_output.rds")
saveRDS(out_gs, "../Results/GrandeSynthe/Stab_clustering_output.rds")

pdf("../Figures/Luxembourg/Stab_clustering_calib.pdf")
par(mar=c(7, 5, 7, 6))
...
pdf("../Figures/France/Stab_clustering_calib.pdf")
par(mar=c(7, 5, 7, 6))
...
pdf("../Figures/GrandeSynthe/Stab_clustering_calib.pdf")
par(mar=c(7, 5, 7, 6))
...
pdf("../Figures/Luxembourg/HC_complete_focus_dendrogram.pdf")
plot(hc_lux, cex = 0.6, hang = -1)
rect.hclust(hc_lux , k = lambda_lux, border = 2:6)
dev.off()

pdf("../Figures/France/HC_complete_focus_dendrogram.pdf")
plot(hc_fra, cex = 0.6, hang = -1)
rect.hclust(hc_fra , k = lambda_fra, border = 2:6)
dev.off()

pdf("../Figures/GrandeSynthe/HC_complete_focus_dendrogram.pdf")
...
pdf("../Figures/Luxembourg/HC_complete_fs.pdf")
...
pdf("../Figures/France/HC_complete_fs.pdf")
...
pdf("../Figures/GrandeSynthe/HC_complete_fs.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Luxembourg/HC_complete_fs_dendrogram.pdf")
plot(hc_lux, cex = 0.6, hang = -1)
rect.hclust(hc_lux , k = lambda_lux, border = 2:6)
dev.off()

pdf("../Figures/France/HC_complete_fs_dendrogram.pdf")
plot(hc_fra, cex = 0.6, hang = -1)
rect.hclust(hc_fra , k = lambda_fra, border = 2:6)
dev.off()

pdf("../Figures/GrandeSynthe/HC_complete_fs_dendrogram.pdf")
plot(hc_gs, cex = 0.6, hang = -1)
rect.hclust(hc_gs , k = lambda_gs, border = 2:6)
dev.off()
...
pdf("../Figures/Luxembourg/HC_complete_ss.pdf")
...
pdf("../Figures/France/HC_complete_ss.pdf")
...
pdf("../Figures/GrandeSynthe/HC_complete_ss.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Luxembourg/HC_complete_ss_dendrogram.pdf")
plot(hc_lux, cex = 0.6, hang = -1)
rect.hclust(hc_lux , k = lambda_lux, border = 2:6)
dev.off()

pdf("../Figures/France/HC_complete_ss_dendrogram.pdf")
plot(hc_fra, cex = 0.6, hang = -1)
rect.hclust(hc_fra , k = lambda_fra, border = 2:6)
dev.off()

pdf("../Figures/GrandeSynthe/HC_complete_ss_dendrogram.pdf")
plot(hc_gs, cex = 0.6, hang = -1)
rect.hclust(hc_gs , k = lambda_gs, border = 2:6)
dev.off()
...
# Plot the obtained dendrogram
pdf("../Figures/Luxembourg/HC_complete_wss_dendrogram.pdf")
plot(hc_lux, cex = 0.6, hang = -1)
rect.hclust(hc_lux , k = 20, border = 2:6)
dev.off()

pdf("../Figures/France/HC_complete_wss_dendrogram.pdf")
plot(hc_fra, cex = 0.6, hang = -1)
rect.hclust(hc_fra , k = 20, border = 2:6)
dev.off()

pdf("../Figures/GrandeSynthe/HC_complete_wss_dendrogram.pdf")
plot(hc_gs, cex = 0.6, hang = -1)
rect.hclust(hc_gs , k = 3, border = 2:6)
dev.off()

# cut trees
covar_lux$hc_wss = cutree(hc_lux, k=20)
covar_fra$hc_wss = cutree(hc_fra, k=20)
covar_gs$hc_wss = cutree(hc_gs, k=3)
