...
# Save outputs
saveRDS(out, "../Results/Pooled3/Stab_clustering_output.rds")

pdf("../Figures/Pooled3/Stab_clustering_calib.pdf")
par(mar=c(7, 5, 7, 6))
CalibrationPlot(out)
dev.off()
...
pdf("../Figures/Pooled3/HC_complete_focus_dendrogram.pdf")
...
pdf("../Figures/Pooled3/HC_complete_fs.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Pooled3/HC_complete_fs_dendrogram.pdf")
plot(hc, cex = 0.6, hang = -1)
rect.hclust(hc , k = lambda, border = 2:6)
dev.off()
...
pdf("../Figures/Pooled3/HC_complete_ss.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Pooled3/HC_complete_ss_dendrogram.pdf")
plot(hc, cex = 0.6, hang = -1)
rect.hclust(hc , k = lambda, border = 2:6)
dev.off()
...
pdf("../Figures/Pooled3/HC_complete_wss.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Pooled3/HC_complete_wss_dendrogram.pdf")
plot(hc, cex = 0.6, hang = -1)
...
### Save data sets ----
saveRDS(covar, "../Results/Pooled3/Clustering_membership.rds")
