...
{
  pvals = readRDS(paste0("../Results/",filepaths[m],"/Community_class_univar_pvals.rds"))
  betas = readRDS(paste0("../Results/",filepaths[m],"/Community_class_univar_betas.rds"))
...
{stab = readRDS(paste0("../Results/",filepaths[m],"/Community_class_multivar_output.rds"))
  
  pdf(paste0("../Figures/",filepaths[m],"/Community_class_multivariate_output.pdf"))
  ...
  b = b[-length(b)]
  pdf(paste0("../Figures/",filepaths[m],"/Community_class_multivariate_beta_consistency.pdf"))
  par(mar=c(5,5,1,1))
  ...
  pdf(paste0("../Figures/",filepaths[m],"/Community_class_multivariate_selprop.pdf"), width = 14)
  par(mar=c(15, 5, 1, 1))
  plot(selprop_ranked,
