...
{pdf(paste0("../Figures/",filepaths[m],"/Boxplot_univariate_cont_shortest_path.pdf"), width=12, height=8)
  par(mar=c(20,5,1,1))
...
{pdf(paste0("../Figures/",filepaths[m],"/Boxplot_univariate_cont_shortest_path_by_family.pdf"), width=14)
  par(mar=c(5,5,1,1))
