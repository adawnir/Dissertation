## Clustering (Pooled LUX/GS, excluding isolated children)
## Rin Wada 30 June
...
# Save outputs
saveRDS(out, "../Results/Pooled2/Stab_clustering_output_no_isolated.rds")

pdf("../Figures/Pooled2/Stab_clustering_calib_no_isolated.pdf")
par(mar=c(7, 5, 7, 6))
CalibrationPlot(out)
dev.off()
...
pdf("../Figures/Pooled2/HC_complete_focus_dendrogram_no_isolated.pdf")
...
pdf("../Figures/Pooled2/HC_complete_fs_no_isolated.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Pooled2/HC_complete_fs_dendrogram_no_isolated.pdf")
plot(hc, cex = 0.6, hang = -1)
rect.hclust(hc , k = lambda, border = 2:6)
dev.off()
...
pdf("../Figures/Pooled2/HC_complete_ss_no_isolated.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Pooled2/HC_complete_ss_dendrogram_no_isolated.pdf")
plot(hc, cex = 0.6, hang = -1)
rect.hclust(hc , k = lambda, border = 2:6)
dev.off()
...
pdf("../Figures/Pooled2/HC_complete_wss_no_isolated.pdf")
...
# Plot the obtained dendrogram
pdf("../Figures/Pooled2/HC_complete_wss_dendrogram_no_isolated.pdf")
plot(hc, cex = 0.6, hang = -1)
...
### Save data sets ----
saveRDS(covar, "../Results/Pooled2/Clustering_membership_no_isolated.rds")
saveRDS(mat, "../Results/Pooled2/Chemical_compound_matrix_no_isolated.rds")
