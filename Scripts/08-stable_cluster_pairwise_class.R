...
saveRDS(stab, paste0("../Results/",filepaths[m],"/Stable_cluster_family_class_multivar_output.rds"))


### Stranger metrics ----
compare_fc = sapply(sc, function(x) x==sc)
...
saveRDS(stab, paste0("../Results/",filepaths[m],"/Stable_cluster_stranger_class_multivar_output.rds"))